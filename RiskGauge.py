...
@st.cache_resource
def load_model():
    model = joblib.load('/workspaces/LoanPredictor/rf_risk.pkl')
    return model
...
# Add contact information to the sidebar with perfect alignment
st.sidebar.markdown("---")  # Horizontal line for separation
st.sidebar.subheader("Contact Information")

# Use a table-like structure for alignment
st.sidebar.markdown("""
<div style="font-size: 16px;">
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td><a href="BORFFO.RESEARCH@GMAIL.COM">borffo.research@gmail.com</a></td>
        </tr>
        <tr>
